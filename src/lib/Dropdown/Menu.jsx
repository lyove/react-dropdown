...
function MenuSectionRenderer(props) {
  const className = 'dropdown-portal-menu-section' + (props.className ? ` ${props.className}` : '');

  return (
    <div className={className}>
      <div className="dropdown-portal-menu-section__title">{props.title}</div>
      <div className="dropdown-portal-menu-section__body">{props.children}</div>
    </div>
  );
}
...
export default class MenuPortal extends Component {
  constructor(props) {
    ...
    this.el.classList.add(`${props.containerClass}-portal`);
