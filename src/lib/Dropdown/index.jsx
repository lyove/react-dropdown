...
const DropdownClassName = 'react-version-dropdown';
...
export default class Dropdown extends Component {
  ...
  handleTriggerKeyDown(e) {
    if (typeof this.props.onTriggerKeyDown === 'function') {
      this.props.onTriggerKeyDown();
    }
  ...
  handleOptionClick(val) {
    ...
    if (!this.controlled && this.props.closeOnOptionClick) {
      this.closeMenu(true);
    }
  }
  ...
  render() {
    ...
    const classes = `${DropdownClassName}-trigger${this.props.className ? ` ${this.props.className}` : ''}`;

    return (
      <div className={classes} id={this.props.id}>
        <TriggerElement
          label={this.props.triggerLabel}
          containerClass={DropdownClassName}
